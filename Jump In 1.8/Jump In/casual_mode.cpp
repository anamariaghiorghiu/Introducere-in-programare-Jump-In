...
void joaca_nivel_casual(int latimea_ecranului, int inaltimea_ecranului, bool sunet, int limba, int nivel, int& running){
    if(limba == 1)
        readimagefile("jpg/fundal_tabla/casual_romana.jpg", 0, 0, latimea_ecranului, inaltimea_ecranului);
    else if(limba == 2)
        readimagefile("jpg/fundal_tabla/casual_engleza.jpg", 0, 0, latimea_ecranului, inaltimea_ecranului);
    else if(limba == 3)
        readimagefile("jpg/fundal_tabla/casual_franceza.jpg", 0, 0, latimea_ecranului, inaltimea_ecranului);
    else
        readimagefile("jpg/fundal_tabla/casual_japoneza.jpg", 0, 0, latimea_ecranului, inaltimea_ecranului);
    ...
    if(running){
        if(limba == 1)
            readimagefile("jpg/fundal_tabla/nivel_reusit.jpg", 0, 0, latimea_ecranului, inaltimea_ecranului);
        else if(limba == 2)
            readimagefile("jpg/fundal_tabla/level_passed_casual.jpg", 0, 0, latimea_ecranului, inaltimea_ecranului);
        else if(limba == 3)
            readimagefile("jpg/fundal_tabla/level_passed_franceza.jpg", 0, 0, latimea_ecranului, inaltimea_ecranului);
        else
        readimagefile("jpg/fundal_tabla/level_passed_japoneza.jpg", 0, 0, latimea_ecranului, inaltimea_ecranului);

        Sleep(1000);
    }

}
void start_casual(int latimea_ecranului, int inaltimea_ecranului, bool sunet, int limba){
    int running = true;
    while(running){
        srand(time(NULL));
        int nivel = rand() % 20 + 1;
        joaca_nivel_casual(latimea_ecranului, inaltimea_ecranului, sunet, limba, nivel, running);
    }
}
